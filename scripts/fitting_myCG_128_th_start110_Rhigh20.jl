...
include("../src/main.jl")
initial_th_guess = 110.0
Rhigh_test = 20.0
ths, Rhighs, err, steps = true_conjugate_gradient_optimization_GRMHD(Image_truth, ro, initial_th_guess, Rhigh_test, freq, nx, ny, nmaxstep, fovx, fovy, params.Rout, Rstop; cost_tol = 2e-3, optimize_param = :theta, dump_filepath = dump_filepath, sensemode = "AD")
...
writedlm("./txts/Fitting/th_mks_128-[ths_Rhighs_err]_AD_lambdagrmonty_sigmacut1e99_from_110_30.txt", [ths Rhighs err], '\t')