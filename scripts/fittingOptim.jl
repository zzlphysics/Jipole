...
include("../src/main.jl")
initial_th_guess = 100.0
Rhigh_test = 20.0
ths, _, err, steps = ConjGradOptim(Image_truth, ro, initial_th_guess, Rhigh_test, freq, nx, ny, nmaxstep, fovx, fovy, params.Rout, Rstop; cost_tol = 5e-8, optimize_param = :theta, dump_filepath = dump_filepath)

using DelimitedFiles

writedlm("../txts/Fitting/ths_mks_128-[ths_err]_AD_lambdagrmonty_sigmacut1_optimjl.txt", [ths err], '\t')